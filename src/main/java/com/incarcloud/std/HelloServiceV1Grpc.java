...
public class HelloServiceV1Grpc {
  ...
  public static final io.grpc.MethodDescriptor<HelloV.HelloRequestV1,
      HelloV.HelloResponseV1> METHOD_HELLO =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "com.incarcloud.std.HelloServiceV1", "hello"),
          io.grpc.protobuf.ProtoUtils.marshaller(HelloV.HelloRequestV1.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(HelloV.HelloResponseV1.getDefaultInstance()));
  ...
  public static abstract class HelloServiceV1ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(HelloV.HelloRequestV1 request,
                      io.grpc.stub.StreamObserver<HelloV.HelloResponseV1> responseObserver) {
    ...
    @Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                HelloV.HelloRequestV1,
                HelloV.HelloResponseV1>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceV1BlockingStub extends io.grpc.stub.AbstractStub<HelloServiceV1BlockingStub> {
    ...
    /**
     */
    public HelloV.HelloResponseV1 hello(HelloV.HelloRequestV1 request) {
  ...
  public static final class HelloServiceV1FutureStub extends io.grpc.stub.AbstractStub<HelloServiceV1FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<HelloV.HelloResponseV1> hello(
        HelloV.HelloRequestV1 request) {
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((HelloV.HelloRequestV1) request,
              (io.grpc.stub.StreamObserver<HelloV.HelloResponseV1>) responseObserver);
          break;
        default:
