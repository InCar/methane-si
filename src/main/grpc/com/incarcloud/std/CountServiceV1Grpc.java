...
public class CountServiceV1Grpc {
  ...
  public static final io.grpc.MethodDescriptor<com.incarcloud.std.HelloM.HelloCountArgV1,
      com.incarcloud.std.HelloM.HelloCountV1> METHOD_COUNT =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "com.incarcloud.std.CountServiceV1", "Count"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.incarcloud.std.HelloM.HelloCountArgV1.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.incarcloud.std.HelloM.HelloCountV1.getDefaultInstance()));
  ...
  public static abstract class CountServiceV1ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void count(com.incarcloud.std.HelloM.HelloCountArgV1 request,
        io.grpc.stub.StreamObserver<com.incarcloud.std.HelloM.HelloCountV1> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.incarcloud.std.HelloM.HelloCountArgV1,
                com.incarcloud.std.HelloM.HelloCountV1>(
                  this, METHODID_COUNT)))
          .build();
    }
  }
  ...
  public static final class CountServiceV1BlockingStub extends io.grpc.stub.AbstractStub<CountServiceV1BlockingStub> {
    ...
    /**
     */
    public com.incarcloud.std.HelloM.HelloCountV1 count(com.incarcloud.std.HelloM.HelloCountArgV1 request) {
  ...
  public static final class CountServiceV1FutureStub extends io.grpc.stub.AbstractStub<CountServiceV1FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.incarcloud.std.HelloM.HelloCountV1> count(
        com.incarcloud.std.HelloM.HelloCountArgV1 request) {
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_COUNT:
          serviceImpl.count((com.incarcloud.std.HelloM.HelloCountArgV1) request,
              (io.grpc.stub.StreamObserver<com.incarcloud.std.HelloM.HelloCountV1>) responseObserver);
          break;
        default:
